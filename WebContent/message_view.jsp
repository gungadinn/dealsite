...
<div class="container">
<div class="card">
<div class="card-header" id="card-header"><h4 id="card-header">쪽지 보기</h4></div>
<div class="card-body">
...
<div class="col-sm-10">${data.mi_content}</div>
</div>

<hr>
<button class="btn btn-primary pull-right"><a href="message_list.do" id="SendNote">목록으로</a></button>
</div>
