...
<div class="col-sm-12">
<div class="card">
<div class="card-header" id="card-header"><h3 id="card-header">구매글  목록</h3></div>
<div class="card-body">
...
<tr>
<td>${list.num }</td>
<td><a href="buy_view.do?idx=${list.num}">${list.item}</a></td>
<td>${list.location }</td>
<td>${list.time }</td>
<td>${list.hit }</td>
</tr>
...
<button type="button" class="btn btn-outline-dark pull-right" onclick="window.location='buy_form.jsp'">글쓰기</button>
...
<li class="page-item"><a class="page-link" href="buy_list.do">1</a></li>
<li class="page-item">
