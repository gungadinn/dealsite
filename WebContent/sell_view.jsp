...
<button type="submit" class="btn btn-secondary" OnClick="window.location='sell_form.jsp'">글쓰기</button>
<button type="submit" class="btn btn-secondary"  OnClick="window.location='sell_list.do'">목록으로</</button>

<form action="sell_edit.do">
	<button type="submit" class="btn btn-secondary">수정</button>
	<input type="hidden"  name="idx" value="${data.num}">
</form>
<form action="sell_delete.do" id="form-button">
