...
<div class="card">
<div class="card-header text-center" id="card-header"><h3 id="card-header">회원가입</h3></div>
<div class="card-body">
...
<div class="form-group row">
  <label for="inputBirthday" class="col-sm-2">생일</label>
  <div class="col-sm-4">
  <input type="text" class="form-control" placeholder="년(4자)" name="birthyy">
</div>
  <div class="col-sm-3">
<select class="form-control" name="birthmm">
  ...
  <div class="col-sm-3">
  <input type="text" class="form-control" id="inputBirthday" name="birthdd">
</div>
</div>
...
<div class="col-sm-5">
<select class="form-control" name="mail2">
