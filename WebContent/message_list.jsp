...
<div class="container">
<div class="card">
<div class="card-header" id="card-header"><h4 id="card-header">쪽지 목록</h4></div>
<div class="card-body">
<form>
...
<tbody>
<tr>
<td>${list.mi_sendid}</td>
<td>${list.mi_receiveid}</td>
<td><a href="message_view.do?mi_num=${list.mi_num}">${list.mi_content}</a></td>
</tr>
</c:forEach>
...
<hr/>
<button class="btn btn-primary pull-right"><a href="message_form.jsp" id="SendNote">쪽지 보내기</a></button>
</form>
