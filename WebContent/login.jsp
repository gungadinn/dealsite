...
<div class="col-sm-9 main-form"><input type="text" class="form-control" placeholder="ID" name="uid"></div>
</div>
</div>
...
<div class="col-sm-9 main-form"><input type="password" class="form-control" placeholder="password" name="upw"></div>
</div>
</div>
